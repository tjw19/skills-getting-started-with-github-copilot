...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice and compete in local soccer matches",
    ...
    "Art Club": {
        "description": "Explore painting, drawing, and mixed media artwork",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["lucas@mergington.edu", "ella@mergington.edu"]
    },
    "Drama Club": {
        "description": "Work on acting, stagecraft, and school productions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
